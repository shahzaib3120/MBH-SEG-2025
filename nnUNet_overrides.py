...
os.environ["nnUNet_raw"] = (
    "/home/ranashah/scratch/MBH-SEG-2024-winning-solution/nnUNet_raw"
)
os.environ["nnUNet_preprocessed"] = (
    "/home/ranashah/scratch/MBH-SEG-2024-winning-solution/nnUNet_preprocessed"
)
os.environ["nnUNet_results"] = (
    "/home/ranashah/scratch/MBH-SEG-2024-winning-solution/nnUNet_results"
)
...
class nnUNetDatasetBlosc2MultiLabel(nnUNetDatasetBlosc2):
    def __init__(
        ...
        self.csv_df["patientID_studyID"] = (
            self.csv_df["patientID_studyID"].str.split("_").str[0]
        )
        self.csv_df["patientID"] = (
            self.csv_df["patientID_studyID"].str.split("_").str[0]
        )
...
class nnUNetTrainerMultiLabel(nnUNetTrainer):
    ...
    def __init__(
        ...
        self.num_classes = (
            5  # epidural, intraparenchymal, intraventricular, subarachnoid, subdural
        )
    ...
    def _build_classification_network(self, segmentation_network):
        ...
        if hasattr(segmentation_network, "encoder"):
            ...
            encoder_features = (
                32  # This might need adjustment based on actual architecture
            )
    ...
    def train_step(self, batch: dict) -> dict:
        ...
        ).float()  # Ensure float for BCE loss
    ...
    def on_validation_epoch_end(self, val_outputs: List[dict]):
        ...
        for i, class_name in enumerate(class_names):
            self.logger.log(
                f"val_acc_{class_name}", per_class_acc[i], self.current_epoch
            )
        ...
        for i, class_name in enumerate(class_names):
            self.print_to_log_file(
                f"Validation {class_name} accuracy: {per_class_acc[i]:.4f}"
            )
