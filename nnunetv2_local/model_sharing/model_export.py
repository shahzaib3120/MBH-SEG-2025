...
def export_pretrained_model(
	...
	with zipfile.ZipFile(output_file, 'w', zipfile.ZIP_DEFLATED) as zipf:
		for c in configurations:
			...
			assert isfile(join(trainer_output_dir, 'plans.json')), (
			...
			source_folder = join(
				trainer_output_dir, f'crossval_results_folds_{folds_tuple_to_string(folds)}'
			)
			if isdir(source_folder):
				if export_crossval_predictions:
					...
					source_files = [
						...
						for i in ['summary.json', 'postprocessing.pkl', 'postprocessing.json']
					]
