...
LIST_OF_IO_CLASSES = [NaturalImage2DIO, SimpleITKIO, Tiff3DIO, NibabelIO, NibabelIOWithReorient]
...
def determine_reader_writer_from_dataset_json(
	...
	return determine_reader_writer_from_file_ending(
		dataset_json_content['file_ending'], example_file, allow_nonmatching_filename, verbose
	)
